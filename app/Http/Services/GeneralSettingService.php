...
//        $this->setting->dashboard_language_id = $request->dashboard_language_id ?? $this->setting->dashboard_language_id;
        ...
        if ($request->logo_image_id)
        {
            deleteFile($this->setting->logo);
            saveImageFromMedia($request->logo_image_id, $this->setting, 'logo');
        }
        ...
        if ($request->dark_logo_image_id)
        {
            deleteFile($this->setting->dark_logo);
            saveImageFromMedia($request->dark_logo_image_id, $this->setting, 'dark_logo');
        }
        ...
        if ($request->favicon_image_id)
        {
            deleteFile($this->setting->favicon);
            saveImageFromMedia($request->favicon_image_id, $this->setting, 'favicon');
        }
