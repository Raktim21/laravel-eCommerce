            ...
            if ($pickup) {
                ...
                $response = $client->post(eCourier()['url'] . '/order-place-reseller', [
                    ...
                    'json' => [
                        ...
                        "package_code"          => $order->deliveryAddress->upazila->district->name == 'Dhaka' ? '#2416' : '#2453', // production
//                        "package_code"          => $order->deliveryAddress->upazila->district->name == 'Dhaka' ? '#2711' : '#2605', // development
