                    ...
                    <ul class="products-cart">
                        ...
                        <li class="pr-cart-item">
                            ...
                            <div class="price-field produtc-price">
                                <p class="price">Price: ${{$item->model->regular_price}}</p>
                            </div>
                            <div class="quantity">
                                <div class="quantity-input">
                                    ...
                                    <a class="btn btn-increase" href="#"
                                        wire:click.prevent="increaseItem('{{$item->rowId}}')"></a>
                                    <a class="btn btn-reduce" href="#"
                                        wire:click.prevent="decreaseItem('{{$item->rowId}}')"></a>
                                </div>
                            </div>
                            ...
                            <div class="delete">
                                <a href="#" wire:click.prevent="destroyItem('{{$item->rowId}}')" class="btn btn-delete"
                                    title="">
