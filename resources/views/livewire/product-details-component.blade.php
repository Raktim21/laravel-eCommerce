                ...
                <div class="col-lg-9 col-md-8 col-sm-8 col-xs-12 main-content-area">
                    <div class="wrap-product-detail">
                        <div class="detail-media">
                            <div class="product-gallery">
                                <ul class="slides">
                                    ...
                                    <li data-thumb="{{asset('assets/images/products/'.$details->image)}}">
                                        <img src="{{asset('assets/images/products/'.$details->image)}}"
                        ...
                        <div class="detail-info">
                            ...
                            <div class="wrap-price"><span class="product-price">{{$details->regular_price}}</span></div>
                            <div class="stock-info in-stock">
                                <p class="availability">Availability: <b>{{$details->stock_status}}</b></p>
                            </div>
                            <div class="quantity">
                                <span>Quantity:</span>
                            ...
                            <div class="wrap-butons">
                                <a href="#" class="btn add-to-cart" wire:click.prevent='store({{$details->id}})'>Add to Cart</a>
                                <div class="wrap-btn">
                                            ...
                                            <ol class="commentlist">
                                                <li class="comment byuser comment-author-admin bypostauthor even thread-even depth-1"
                                                    ...
                                                    <div id="comment-20" class="comment_container">
                                                        <img alt="" src="{{asset('assets/images/au'.$details->image)}}"
                                                            height="80" width="80">
                                ...
                                <div class="product product-style-2 equal-elem ">
                                    ...
                                    <div class="product-info">
                                        ...
                                        <div class="wrap-price">
                                            <span  class="product-price">{{$related_product->regular_price}}</span>
                                        </div>
                                    </div>
                                </div>
                                @endforeach
